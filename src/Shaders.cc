...
namespace Shaders
{
    ...
    std::pair<VkShaderModule, VkResult>
    createShaderModule(VkDevice const& logicalDev, std::vector<uint8_t> const& spvSource)
    {
        ...
        VkResult ret = vkCreateShaderModule(
                logicalDev, &createInfo, nullptr, &shaderModule);
