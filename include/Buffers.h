...
public:
    ...
    void copyDataFrom(VkBuffer const& src, VkQueue& transferQueue, VkCommandPool& transferCmdPool)
        const;
    void cmdCopyDataFrom(VkBuffer const& src, VkCommandBuffer& transferBuffer) const;

    void copyDataFrom(Buffer const& src, VkQueue& transferQueue, VkCommandPool& transferCmdPool)
        const;
