...
template<typename T>
class StorageBufferArray : public Buffers::Buffer
{
public:
    StorageBufferArray(
            VkDevice* dev,
            ...
            : Buffers::Buffer(dev, allocator, physicalDev,
                              maxAllocatedSize * sizeof(T) + sizeof(glm::vec4),
