...
public:
    ...
    Image(
        ...
        VkImageTiling const& tiling = VK_IMAGE_TILING_OPTIMAL, uint32_t const& mipLevels = 1,
    ...
    Image(
        ...
        std::tuple<uint32_t, uint32_t, uint32_t> size, VkFormat const& imgFormat,
        VkImageUsageFlags const& usage, VkMemoryPropertyFlags const& memoryFlags,
        std::optional<VkSamplerCreateInfo> const& samplerCreateInfo,
        optUint32Set const& queueTransfers = nullopt,
        VkImageTiling const& tiling = VK_IMAGE_TILING_OPTIMAL, uint32_t const& mipLevels = 1,
        VkImageLayout const& initialLayout = VK_IMAGE_LAYOUT_UNDEFINED,
    ...
    VkResult createImage(
        VkFormat const& imgFormat, VkImageUsageFlags const& usage,
        VkMemoryPropertyFlags const& memoryFlags, std::optional<std::set<uint32_t>> const& queues,
    ...
    VkResult createBaseImageView(
        VkFormat const& format, VkImageViewType const& viewType,
        VkImageAspectFlags const& aspectFlags = VK_IMAGE_ASPECT_COLOR_BIT
    );
